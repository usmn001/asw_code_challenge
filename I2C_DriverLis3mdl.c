...
//
// OUTPUT DATA FOR X-AXIS IS PROVIDED BY READING THE OUTPUT REGISTERS OUT_X_L AND OUT_X_H FOR FOR LSB AND MSB VALUES CONTAINING
// BOTH LSB AND MSB VALUES IN 2ś COMPLEMENT FORM.
// 
//
// @author M USMAN
// Input:
...
//
// Output: 
// @param LIS3MDL_getOutputDataX    : PROVIDING X AXIS 16-Bit OUTPUT DATA IN THE RANGE OF -16 GAUSS TO +16 GAUSS.THE OUTPUT VALUES ARE
//                                    STORED IN 2s COMPLEMENT FORM, TYPICAL VALUES OF OUTPUT PARAMETER ARE : 
//                                    0xFFFC FOR -4 GAUSS
//                                    0x0004 FOR +4 GAUSS
//                                    0xFFF8 FOR -8 GAUSS
//                                    0x0008 FOR +8 GAUSS
...
// Input:
// @param LIS3MDL_I2C_ADDRESS_READ  : I2C BUS READ ADDRESS
// @param LIS3MDL_OFFSET_Y_REG_H_M  : ADDRESS OF HSB OFFSET REGISTER FOR Y AXIS
// @param LIS3MDL_OFFSET_Y_REG_L_M  : ADDRESS OF LSB OFFSET REGISTER FOR Y AXIS
// @param LIS3MDL_DATA8             : SPECIFYING 8 NUMBER OF BITS TO BE READ ON 12C BUS
//
// Output: 
// @param LIS3MDL_getOffset_Y       : PROVIDING Y AXIS 16-Bit OFFSET. 
//                                 
//
//
...
//
// OUTPUT DATA FOR Y-AXIS IS PROVIDED BY READING THE OUTPUT REGISTERS OUT_Y_L AND OUT_Y_H FOR FOR LSB AND MSB VALUES CONTAINING
// BOTH LSB AND MSB VALUES IN 2ś COMPLEMENT FORM. 
// 
//
// @author M USMAN
...
// @param LIS3MDL_OUT_Y_H           : ADDRESS OF OUTPUT REGISTER WITH MSB FOR Y AXIS.
// @param LIS3MDL_DATA8             : SPECIFYING 8 NUMBER OF BITS TO BE SENT ON 12C BUS.
//
// Output: 
// @param LIS3MDL_getOutputDataY    : PROVIDING Y AXIS 16-Bit OUTPUT DATA IN THE RANGE OF -16 GAUSS TO +16 GAUSS. THE OUTPUT VALUES ARE
//                                    STORED IN 2s COMPLEMENT FORM, TYPICAL VALUES OF OUTPUT PARAMETER ARE : 
//                                    0xFFFC FOR -4 GAUSS
//                                    0x0004 FOR +4 GAUSS
//                                    0xFFF8 FOR -8 GAUSS
...
//
// OUTPUT DATA FOR Z-AXIS IS PROVIDED BY READING THE Z AXIS OUTPUT REGISTERS OUT_Z_L , OUT_Z_H FOR MSB & LSB CONTAINING
// BOTH LSB AND MSB VALUES IN 2ś COMPLEMENT FORM.
// 
//
// @author M USMAN
...
//
// Output: 
// @param LIS3MDL_getOutputDataZ    : PROVIDING Z AXIS 16-Bit OUTPUT DATA IN THE RANGE OF -16 GAUSS TO +16 GAUSS.THE OUTPUT VALUES ARE
//                                    STORED IN 2s COMPLEMENT FORM, TYPICAL VALUES OF OUTPUT PARAMETER ARE : 
//                                    0xFFFC FOR -4 GAUSS
//                                    0x0004 FOR +4 GAUSS
//                                    0xFFF8 FOR -8 GAUSS
